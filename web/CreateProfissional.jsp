        ...
        <div class="wrapper box row row-offcanvas row-offcanvas-left">
            ...
            <ul class="nav navbar-nav">
                <li id="aba-info" class="aba active">
                    <a href="#" role="tab" data-toggle="tab">Criar Profissional</a>
                </li>
            </ul>
    ...
    <div class="padding">
        <form name="edit" action="ServletController" method="POST">
            <div class="full col-sm-9">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr class="">
                            ...
                            <td class="">
                                ...
                                <input type="text" name="nometextbox" value=""/>
                        ...
                        <tr class="">
                            ...
                            <td class="">
                                ...
                                <input type="text" name="cpftextbox" value=""/>
                        ...
                        <tr class="">
                            ...
                            <td class="">
                                <input type="text" name="enderecotextbox" value="" />
                        ...
                        <tr class="">
                            ...
                            <td class="">
                                <input type="text" name="teltextbox" value="" />
                ...
                <input type="hidden" name="cmd" value="soshome.model.command.CreateProfissional" />
                <input type="submit" value="Salvar" class="btn btn-primary btn pull-right"/>
                <!--
