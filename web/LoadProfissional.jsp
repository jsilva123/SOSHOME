            ...
            <div class="full col-sm-9">
                ...
                <div class="row panel panel-primary">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Profissional</h3>
                    </div>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr class="">
                            ...
                            <td class="">
                                <input type="text" name="enderecotextbox" value="${profissional.getEndereco()}" />
                        ...
                        <tr class="">
                            ...
                            <td class="">
                                <input type="text" name="teltextbox" value="${profissional.getTelefone()}" />
                ...
                <input type="hidden" name="cmd" value="soshome.model.command.EditProfissional" />
